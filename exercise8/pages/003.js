    ...
    data: function() {
        return {
            ...
            flipswitchData: {
                ...
                repeatOnFail: false, 
                questions: [{
                    text: 'Adaptable – able to adjust to any situation',
                    selected: false,
                },{
                    text: 'Innovative and creative utilising all experiences',
                    selected: false
                },{
                    text: 'Tolerant of change',
                    selected: false,
                }]
            },modals: [{
                // The title text in the modal. Can be blank
                title: 'Adaptable – able to adjust to any situation',
                // Must be unique
                id: 'modalOne',
                ...
                // The title text in the modal. Can be blank
                title: 'Innovative and creative utilising all experiences',
                // Must be unique
                id: 'modalTwo',
                // The text in the button
                buttonText: 'Click me',
